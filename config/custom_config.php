...
$options->cache_time = getenv('RSS_CACHE_TIME');
...
$options->admin_credentials = array('username'=>getenv('RSS_ADMIN_USER'), 'password'=>getenv('RSS_ADMIN_PASSWORD'));
...
$options->api_keys[1] = getenv('RSS_API_KEY');
